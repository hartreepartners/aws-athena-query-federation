 ...
 * #L%
 */
package com.amazonaws.connectors.athena.jdbc.crate;
 ...
 * information_schema.
 */
public class CrateMetadataHandler
        extends JdbcMetadataHandler
{
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(CrateMetadataHandler.class);
    ...
    @VisibleForTesting
    protected CrateMetadataHandler(final DatabaseConnectionConfig databaseConnectionConfig, final AWSSecretsManager secretsManager,
